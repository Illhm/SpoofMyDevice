...
import com.devicespooflab.hooks.hooks.CpuInfoHooks;
...
public class MainHook implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) {
        ...
        try {
            CpuInfoHooks.hook(lpparam);
            XposedBridge.log(TAG + ": CpuInfoHooks loaded");
        } catch (Exception exception) {
            XposedBridge.log(TAG + ": CpuInfoHooks failed: " + exception.getMessage());
        }
